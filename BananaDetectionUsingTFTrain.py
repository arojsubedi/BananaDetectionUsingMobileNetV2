...
from BananaDetectionUsingTF import build_model
...
def load_dataset(path,split=0.1):
    images,bboxes =[],[]
    df = pd.read_csv(os.path.join(path,"bananas_train","label.csv"))
    for index,row in df.iterrows():
        ...
        image = path+"/bananas_train/images/"+name
        #pascalformat
        bbox = [x1,y1,x2,y2]
        images.append(image)
        bboxes.append(bbox)
...
if __name__ == "__main__":
    ...
    dataset_path='C:/Users/subediaj/OneDrive - University of Cincinnati/Aroj_OCCLab_ObjectDetectionProjects/ObjectDetectionProjects/BananaDetectionUsingMobileNetV2/banana-detection'
